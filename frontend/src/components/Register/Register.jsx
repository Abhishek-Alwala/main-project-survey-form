...
function Register() {
    ...
    async function registerUser(event) {
        ...
        const response = await fetch('http://localhost:7171/user/register', {
            method: 'POST',
            body: formData
        })
            ...
            <div className='register'>
                ...
                <div className='inputs'>
                    ...
                    <div>
                     ...
                     <h3>Agree Terms and Conditions</h3>  <input disabled={check} id='btnregister' type='submit' value='Register' />
                </form>
            </div>
        </div>
    );
